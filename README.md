...
* Previous version had default vertical offset 1.65, but this is now a mandatory argument. Though it should be 0.00, it seems to depend on situation. I used to use 1.65, but I now use 0.00. I cannnot explain why this happens.
